      ...
      <div className="w-full md:w-1/3 p-6 flex flex-col items-center bg-gray-100">
        ...
        <div className="flex flex-col gap-4 text-center  w-full">
          ...
          <h1 className="flex items-center gap-3 justify-center">
            ...
            <span>{user?.userGroupMember_id.usergroup_id.name || <Skeleton />}</span>
          </h1>
    ...
    <UserInfo isOpen={isModalOpen} onClose={closeModal}>
      ...
      <form ref={form} onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <label htmlFor="male" className="mr-4 ml-1">Homme</label>
          <input type="radio" id="female" name="gender" value="female" onChange={handleChange} />
          <label htmlFor="female" className="ml-1">Femme</label>
        </div>
        <input
          type="text"
          name="phoneNumber"
